...
!
        real*8 function vpot1(v0,a,r0,z12,mu,l,r)
        real*8::v0,a,r0,z12,mu,r
        integer::l
        vpot1=vpotnn(v0,a,r0,r)+vpotcoul(z12,r0,r)
     &   +vpotcent(mu,l,r)
        end function vpot1
!
...
!
        ...
        real*8::Q,mu,v0,a,r0,z12,r
        integer::l
        kr=2d0*mu/hbarc**2*(Q-vpot1(v0,a,r0,z12,mu,l,r))
        end function kr
